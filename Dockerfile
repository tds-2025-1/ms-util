# docker build -t ms-util:latest .
# docker image ls

# taggear no remoto:
# docker tag ms-util:latest ghcr.io/tds-2025-1/ms-util:latest

# logar no ghcr com docker (use o PAT (token))
# docker login ghcr.io -u profmarciotorres

# empurrar a imagem para o ghcr
# docker push ghcr.io/tds-2025-1/ms-util:latest
